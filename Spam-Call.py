...
w=('\033[1;37m')
print("""%s
	SPAM CALL MASSAL V1.0%s

------------------------------------------------
%sAuthor: ARULI-AZMI%s
------------------------------------------------
%sContact: https://t.me/Aruli_06%s
------------------------------------------------
...
no1 = input("[?] NO TARGET1 => %s"%(w))
no2 = input("%s[?] NO TARGET2 => %s"%(g,w))
no3 = input("%s[?] NO TARGET3 => %s"%(g,w))
